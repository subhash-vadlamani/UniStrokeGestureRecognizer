...
class Screen():
    def __init__(self):
        ...
        #Button to be pressed when the user is ready to draw the gestures.
    ...
    def on_mouse_dragged(self, event):
        ...
        # Storing the points that the user is drawing in the 'gesturepoints' list
    ...
    def on_mouse_up(self, event):
        # Commenting the recognition part of the code since recognition should not be done in this part of the project
        pass
    ...
    def submit_btn_click(self):
        ...
        # Storing the current set of points collected in the list called 'allgestures'.
    ...
    # Button to be pressed so that the user can know gesture to draw currently
    ...
    # Button to be pressed after the username has been entered. This username is used to create the folder in the
    # user_logs forlder so that all the gestures corresponding to this particular user can be stored.
