...
class Screen():
    def __init__(self):
        ...
        self.clear_button = Button(self.top, text='Clear', width=25, command=self.clear_btn_click)
    ...
    def on_mouse_dragged(self, event):
        ...
        self.line_points.append((x, y, time.time()))
        global_x, global_y = event.x, event.y
    ...
    def submit_btn_click(self):
        ...
        recognizer.store_gesture_in_xml(self.line_points)
