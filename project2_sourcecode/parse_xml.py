...
for folderName in os.listdir(cwd):
    ...
    # userFolder = userFolder + '/medium'
    gestureList = []
    gestureMap = {}
    for xml in os.listdir(userFolder):
        ...
        if root.attrib.get('Number').startswith('0'):
            number = int(root.attrib.get('Number')[1:])
        else:
...
with open("gesture_logs_protractor_trackpad_sample.csv", 'w', newline='') as file:
        ...
        for E in range(1, 2):
            ...
            for i in range(1, 11):
                ...
                for template in templatelist:
                    ...
                    recognizer.addGestureVector(template)
                ...
                for candidate in candidatelist:
                    ...
                    # This is the result for recognition with Protractor
                    matched_gesture, score, n_best_list = recognizer.protractorRecognizeWithNBestList(candidate.points)

                    # This is the result for recognition with GSS
